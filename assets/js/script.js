...
generatePasswordLength = function () {
  // resetting some variables in case the button is pressed again.
...
// asks user for password criteria and sets up variables to deliver that
...
var generatePassword = function () {
  ...
  for (var i = 1; i <= passwordLengthNum; i++) {
    ...
    var characterType =
      passwordArray[randomNumberForArray(passwordArray.length)];
    ...
    switch (characterType) {
      case 1:
        password += lowercaseArray[randomNumberForArray(lowercaseArray.length)];
        lowercaseCharacterCheck = true;
        break;
      case 2:
        password += uppercaseArray[randomNumberForArray(uppercaseArray.length)];
        uppercaseCharacterCheck = true;
        break;
      case 3:
        password += numArray[randomNumberForArray(numArray.length)];
        numCharacterCheck = true;
        break;
      case 4:
        password += symbolArray[randomNumberForArray(symbolArray.length)];
